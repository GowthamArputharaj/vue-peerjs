<template>
  <div id="navigation" class="">
    <nav class="navbar navbar-expand-lg navbar-light text-monospace font-weight-bold fixed-bottom mb-2 bg-transparent">
      ...
      <button class="navbar-toggler  " type="button" id="nav-tgl" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
        <span class="navbar-toggler-icon"></span>
      </button>
      
      <div class="w-75 collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav"> 
